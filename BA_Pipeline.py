...
if st.button("Process Requirements", type="primary"):
    if not gemini_key:
        ...
        with st.status("🧠 Agents are analyzing requirements... Please wait.", expanded=True) as status:
            ...
            chat_results = BA_Manager_Agent.initiate_chat(recipient=feature_extract_agent, message=raw_requirements,max_turns=2,summary_method="last_msg")
        ...
        AC_agent_chat = BA_Manager_Agent.chat_messages[BA_Manager_Agent]
        detailed_output = ""
